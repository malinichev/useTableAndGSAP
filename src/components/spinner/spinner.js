      ...
      return(
        ...
        <svg style={style.svg} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
            ...
            <g  id="dots">
                ...
                <path ref={el=>{dot1Item = el}} id="dot3" fill="#CCCCCC" d="M77,23.9c0.6,0,1.2,0.2,1.6,0.6s0.6,0.9,0.6,1.5s-0.2,1.1-0.6,1.5c-0.4,0.4-1,0.6-1.6,0.6
                    c-0.7,0-1.2-0.2-1.6-0.6c-0.4-0.4-0.6-0.9-0.6-1.5s0.2-1.1,0.6-1.5S76.3,23.9,77,23.9z"/>
                <path ref={el=>{dot2Item = el}} id="dot2" fill="#CCCCCC" d="M77,23.9c0.6,0,1.2,0.2,1.6,0.6s0.6,0.9,0.6,1.5s-0.2,1.1-0.6,1.5c-0.4,0.4-1,0.6-1.6,0.6
                    c-0.7,0-1.2-0.2-1.6-0.6c-0.4-0.4-0.6-0.9-0.6-1.5s0.2-1.1,0.6-1.5S76.3,23.9,77,23.9z"/>
                <path ref={el=>{dot3Item = el}} id="dot1" fill="#CCCCCC" d="M77,23.9c0.6,0,1.2,0.2,1.6,0.6s0.6,0.9,0.6,1.5s-0.2,1.1-0.6,1.5c-0.4,0.4-1,0.6-1.6,0.6
                    c-0.7,0-1.2-0.2-1.6-0.6c-0.4-0.4-0.6-0.9-0.6-1.5s0.2-1.1,0.6-1.5S76.3,23.9,77,23.9z"/>
            </g>
            </svg>
