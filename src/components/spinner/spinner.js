    ...
    useEffect(()=>{
      ...
      return(
        <>
            ...
            <g>
                <path fill="#FFFFFF" d="M36,28.1c-0.1-0.2-0.2-0.5-0.3-0.8c-0.5,0.7-1.3,1-2.2,1c-0.9,0-1.6-0.3-2.2-0.8c-0.6-0.5-0.9-1.2-0.9-2
                ...
                <path fill="#FFFFFF" d="M43.1,28.1h-2.9V15h2.9V28.1z"/>
                <path fill="#FFFFFF" d="M44.8,16.5c0-0.4,0.1-0.7,0.4-1c0.3-0.3,0.7-0.4,1.1-0.4c0.5,0,0.9,0.1,1.1,0.4c0.3,0.3,0.4,0.6,0.4,1
                ...
                <path fill="#FFFFFF" d="M52.3,18.9l0.1,1.1c0.6-0.8,1.5-1.3,2.6-1.3c1,0,1.7,0.3,2.1,0.9c0.5,0.6,0.7,1.4,0.7,2.6v5.9H55v-5.8
                    c0-0.5-0.1-0.8-0.3-1c-0.2-0.2-0.5-0.3-1-0.3c-0.6,0-1,0.2-1.3,0.7v6.5h-2.9v-9.2H52.3z"/>
                <path fill="#FFFFFF" d="M59.4,16.5c0-0.4,0.1-0.7,0.4-1s0.7-0.4,1.1-0.4c0.5,0,0.9,0.1,1.1,0.4s0.4,0.6,0.4,1s-0.1,0.7-0.4,1
                    s-0.7,0.4-1.1,0.4c-0.5,0-0.9-0.1-1.1-0.4S59.4,16.9,59.4,16.5z M62.5,28.1h-2.9v-9.2h2.9V28.1z"/>
                <path fill="#FFFFFF" d="M71.8,23.2H73v2.2h-1.3v2.6h-2.9v-2.6h-4.8L64,23.7l5-8v0h2.9V23.2z M66.7,23.2h2.2v-3.8l-0.2,0.3
                    L66.7,23.2z"/>
            </g>
            <g id="logo">
            ...
            <g id="dots">
                <path ref={el=>{dot1Item = el}} id="dot3" fill="#FFFFFF" d="M77,23.9c0.6,0,1.2,0.2,1.6,0.6s0.6,0.9,0.6,1.5s-0.2,1.1-0.6,1.5c-0.4,0.4-1,0.6-1.6,0.6
                    c-0.7,0-1.2-0.2-1.6-0.6c-0.4-0.4-0.6-0.9-0.6-1.5s0.2-1.1,0.6-1.5S76.3,23.9,77,23.9z"/>
                <path ref={el=>{dot2Item = el}} id="dot2" fill="#FFFFFF" d="M77,23.9c0.6,0,1.2,0.2,1.6,0.6s0.6,0.9,0.6,1.5s-0.2,1.1-0.6,1.5c-0.4,0.4-1,0.6-1.6,0.6
                    c-0.7,0-1.2-0.2-1.6-0.6c-0.4-0.4-0.6-0.9-0.6-1.5s0.2-1.1,0.6-1.5S76.3,23.9,77,23.9z"/>
                <path ref={el=>{dot3Item = el}} id="dot1" fill="#FFFFFF" d="M77,23.9c0.6,0,1.2,0.2,1.6,0.6s0.6,0.9,0.6,1.5s-0.2,1.1-0.6,1.5c-0.4,0.4-1,0.6-1.6,0.6
                    c-0.7,0-1.2-0.2-1.6-0.6c-0.4-0.4-0.6-0.9-0.6-1.5s0.2-1.1,0.6-1.5S76.3,23.9,77,23.9z"/>
            </g>
            </svg>
